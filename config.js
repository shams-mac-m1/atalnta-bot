module.exports = {
	...
	token: "ODQxMzcwMjQ2OTcxNTIzMDcz.YJlxGg.5Xt9suFXduCjW4MPo6Gh9NE-rDE",
	...
	mongoDB: "mongodb+srv://SHAMS:HANNA@cluster0.lkdpn.mongodb.net/db?retryWrites=true&w=majority", // The URl of the mongodb database
	...
	owner: {
		id: "651658967801397269", // The ID of the bot's owner
		name: "Le pharaon BG#9213" // And the name of the bot's owner
	},
	...
	status: [
		{
			name: "@pharaon bg le bot  est sur {serversCount} serveur",
			type: "STREAMING"
		},
		{
			name: "rej the french tower  avec cette invite https://discord.gg/zfNqX84nQw",
			type: "PLAYING"
		}
	]
};
